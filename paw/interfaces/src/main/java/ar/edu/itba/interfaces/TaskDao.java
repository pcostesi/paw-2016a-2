...
public interface TaskDao {
	...
	public Task createTask(final int storyId, final String name, final String description, final Status status, final Optional<User> user, final Score score, final Priority priority);

...
public interface BacklogService {
     ...
     */
    BacklogItem createBacklogItem(final Project project, final String title, final String description);
     ...
     */
    void deleteBacklogItem(final BacklogItem backlogItem);
     ...
     */
    BacklogItem setBacklogItemTitle(final BacklogItem item, final String title);
     ...
     * @return The updated object.
     */
    BacklogItem setBacklogItemDescription(final BacklogItem item, final String description);
     ...
     */
    BacklogItem createBacklogItemFromTask(final Task task, final Project project);
     ...
     * @return The new backlog item.
     */
    BacklogItem createBacklogItemFromStory(final Story story, final Project project);
     ...
     */
    BacklogItem getBacklogById(final int backlogId);
     ...
     */
    boolean titleIsUsed(final Project project, final String title);

			...
			<%@taglib prefix="bs" tagdir="/WEB-INF/tags/bs" %>
				<%@ taglib prefix="form" uri="http://www.springframework.org/tags/form"%>
					<%@taglib uri="http://www.springframework.org/tags" prefix="spring"%>
						...
						<spring:message code="iteration.edit.date.placeholder" var="startDatePlaceholder" />
						...
						<t:page>
							...
							<jsp:body>
								<form:form id="iteration-form" modelAttribute="iterationForm" action="${pageContext.request.contextPath}/project/${project.code()}/iteration/new"
								 method="POST">
									<div class="row">
										<div class="col-sm-6">
											<fieldset>
												...
												<bs:input id="startDate" path="startDate" label="Begin date" dateClass="dateInput" placeholder="${startDatePlaceholder}"
												/>

	...
	<t:collapsiblePanel panelId="iteration-${iteration.number}">
		<jsp:attribute name="title">Iteration #${iteration.number}</jsp:attribute>	
			<jsp:attribute name="actions">
				<a href="/project/${project.code}/iteration/${iteration.iterationId}" class="btn btn-default btn-xs" >
					<span class="glyphicon glyphicon-share-alt" aria-hidden="true"></span> Go to iteration
				</a>
				<t:dropdownEditDelete href="/project/${project.code}/iteration/${iteration.iterationId}"/>
			</jsp:attribute>
			<jsp:body>
				<div class="row">
			        <div class="col-sm-12">

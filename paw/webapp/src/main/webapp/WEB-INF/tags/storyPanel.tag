...
<t:collapsiblePanel panelId="story-${story.storyId}" panelParent="${panelParent}">
	...
	<jsp:attribute name="actions">
	 	<a href="/project/${project.code}/iteration/${iteration.iterationId}/story/${story.storyId}/task/new" class="btn btn-primary btn-xs dropdown-toggle">
		    <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> New task
		</a>
		<t:dropdownEditDelete href="/project/${project.code}/iteration/${iteration.iterationId}/story/${story.storyId}"/>
	</jsp:attribute>
